...
$domainname = 'http://localhost:70/moodle';
                ...
                //var json = JsonConvert.SerializeXmlNode(doc, (Newtonsoft.Json.Formatting)Formatting.None, true);
                //object transactObject1 = JsonConvert.DeserializeObject(json);
              


                //var doc2 = XDocument.Parse(responsea);
                //if (doc2.Root!.Elements("Stars") is { } elements && elements.Count() == 1)
                //{
                //    var jsonNamespace = "http://james.newtonking.com/projects/json";
                //    doc2.Root!.Add(new XAttribute(XNamespace.Xmlns + "json", jsonNamespace));
                //    elements.Single().Add(new XAttribute(XNamespace.Get(jsonNamespace) + "Array", true));
                //}
                // JsonConvert.SerializeXNode(doc2);
...
/// SETUP - NEED TO BE CHANGED
	...
	*/
	...
	$course->courseid  = 4;					// string,      1, Obrigatorio,				Padrão para "weeks" //Formato do curso: weeks, topics, social, site,..
