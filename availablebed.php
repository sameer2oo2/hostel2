...
<div class="row mb-2">
<div class="col-sm-6">
<h1 class="m-0">Available Beds</h1>
</div>
<div class="col-sm-6">
<ol class="breadcrumb float-sm-right">
<li class="breadcrumb-item"><a href="#">Home</a></li>
<li class="breadcrumb-item active">Available Beds </li>
</ol>
</div>
</div>
</div>
...
// $Bookedbeds_lda = "SELECT * FROM `beds` where status = 'booked' AND campus = '2';";
 $Freebeds_lda = "SELECT * FROM `beds` where status = 'available' AND campus = '2';";
...
//  $Bookedbeds_wp = "SELECT * FROM `beds` where status = 'booked' AND campus = '3';";
  $Freebeds_wp = "SELECT * FROM `beds` where status = 'available' AND campus = '3';";
