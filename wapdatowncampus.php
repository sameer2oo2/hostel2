...
include("./include/lefnave.php");
	 ...
	 $allart = "SELECT * FROM `rooms` WHERE campus = '3';";
  
 
 $beds = "SELECT * FROM `beds` WHERE campus = '3';";
 $Bookedbeds = "SELECT * FROM `beds` where status = 'booked' AND campus = '3';";
  $Freebeds = "SELECT * FROM `beds` where status = 'available' AND campus = '3';";
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Wapda Town </li>
          </ol>
        </div>
      </div>
    </div>
