...
include("./include/lefnave.php");
	 ...
	 $allart = "SELECT * FROM `rooms` WHERE campus = '2';";
  
 
 $beds = "SELECT * FROM `beds` WHERE campus = '2';";
 $Bookedbeds = "SELECT * FROM `beds` where status = 'booked' AND campus = '2';";
  $Freebeds = "SELECT * FROM `beds` where status = 'available' AND campus = '2';";
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">LDA Campus</li>
          </ol>
        </div>
      </div>
    </div>
